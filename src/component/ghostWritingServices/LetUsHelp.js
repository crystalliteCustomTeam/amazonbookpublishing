                    ...
                    <div className={`${isLargeScreen ? '' : 'hidden'} grid md:grid-cols-2 grid-cols-4 gap-4 mt-10 items-stretch justify-stretch xs:grid-cols-1 xs:px-5 md:px-5`}>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] p-6 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <Image quality={95} src="/assets/images/newimg/checkmark.png" width={80} height={80} className='mx-auto my-12 ' alt="Seal of Approval" />
                        ...
                        <div className=" ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] p-6 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <Image quality={95} src="/assets/images/newimg/checkmark.png" width={80} height={80} className='mx-auto my-12' alt="Reviewed by editors" />
                        ...
                        <div className=" ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] p-6 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <Image quality={95} src="/assets/images/newimg/checkmark.png" width={80} height={80} className='mx-auto my-12' alt="Unlimited Revisions" />
                        ...
                        <div className=" ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] p-6 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <Image quality={95} src="/assets/images/newimg/checkmark.png" width={80} height={80} className='mx-auto my-12' alt="Rights of Ownership Maintained" />
